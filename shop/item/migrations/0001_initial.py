...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='items', to='item.ItemFeatureCategory', verbose_name='Категорія характеристики'),
        ),
        migrations.AddField(
            model_name='itemfeature',
            name='item',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='features', to='item.Item', verbose_name='Товар'),
        ),
        migrations.AddField(
            model_name='item',
            name='category',
