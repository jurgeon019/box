...
class ItemImage(BaseMixin):
	item      = SortableForeignKey(verbose_name=_("Товар"), to="sw_item.Item", on_delete=models.SET_NULL, related_name='images', null=True)
...
class ItemReview(BaseMixin):
	item    = models.ForeignKey(verbose_name=_("Товар"),  blank=True, null=True, to="sw_item.Item", on_delete=models.SET_NULL, related_name="reviews",)
