    ...
    if file_extension == 'csv':
      if content_type == 'item_category':
        ...
        if action_type == 'import':
          ...
          status = exporter.export_items_categories_to_csv(file_name)   
        ...
        if action_type == 'import':
          ...
          status = exporter.export_categories_to_csv(file_name)   
    if file_extension == 'xlsx':
      if content_type == 'item_category':
        ...
        if action_type == 'import':
          ...
          status = exporter.export_items_to_xlsx(file_name)   
